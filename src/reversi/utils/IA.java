...
public class IA {
	...
	public static int meilleurCoup(Matrice matrice, Stack<Integer> coupsPossibles, int difficulte) {
	...
	private static int nombrePiece(Matrice matrice, int piece, int directionHorizontale, int directionVerticale) {
		...
		int piecesARetourner = Matrice.nombrePieces(directionHorizontale, directionVerticale, deltaX, deltaY);
